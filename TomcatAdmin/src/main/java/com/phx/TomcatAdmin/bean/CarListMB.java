package com.phx.TomcatAdmin.bean;

import com.phx.TomcatAdmin.infra.model.Filter;
import com.phx.TomcatAdmin.model.Car;
import com.phx.TomcatAdmin.service.CarService;
...
import static com.phx.TomcatAdmin.util.Utils.addDetailMessage;
    ...
    public void initDataModel() {
        cars = new LazyDataModel<Car>() {
            ...
            public List<Car> load(int first, int pageSize,
                ...
                com.phx.TomcatAdmin.infra.model.SortOrder order = null;
                if (sortOrder != null) {
                    order = sortOrder.equals(SortOrder.ASCENDING) ? com.phx.TomcatAdmin.infra.model.SortOrder.ASCENDING
                            : sortOrder.equals(SortOrder.DESCENDING) ? com.phx.TomcatAdmin.infra.model.SortOrder.DESCENDING
                            : com.phx.TomcatAdmin.infra.model.SortOrder.UNSORTED;
                }
